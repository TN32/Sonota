...
public class RevenueListAdapter extends BaseAdapter {
    ...
    private ArrayList<RevenueListClass> data = null;
    ...
    public RevenueListAdapter(Context context, ArrayList<RevenueListClass> data, int resource){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // 指定された位置のデータを取得
        RevenueListClass data = (RevenueListClass) getItem(position);
        ...
        ((TextView) convertView.findViewById(R.id.rc_list_month)).setText(data.getMonth());
        dateTextList.add(data.getMonth());
        // こっちの書き方のほうがいつもの書き方なのでわかりやすいかも？
        TextView Amount = (TextView) convertView.findViewById(R.id.rc_list_amout);
