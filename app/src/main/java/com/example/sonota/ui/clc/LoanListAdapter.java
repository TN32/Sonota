...
public class LoanListAdapter extends BaseAdapter {
    ...
    private ArrayList<LoanListDataClass> data = null;

    private int resource = 0;


    // コンストラクタ  MainActivityでアダプターを生成する箇所で呼ばれている
    public LoanListAdapter(Context context, ArrayList<LoanListDataClass> data, int resource){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // 指定された位置のデータを取得
        LoanListDataClass data = (LoanListDataClass) getItem(position);
