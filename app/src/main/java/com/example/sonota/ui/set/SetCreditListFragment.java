...
import com.example.sonota.ui.clc.CreditListDataClass;
...
public class SetCreditListFragment extends CustomFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        for(int i = 1; i <=  5; i++){
            ...
            com.example.sonota.ui.set.CreditListDataClass data = new com.example.sonota.ui.set.CreditListDataClass(i,"カード" + 1,"31","31");
            listData.add(data);
